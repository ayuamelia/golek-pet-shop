...
<div class="table-responsive" style="margin-left: 50px; margin-right: 50px; overflow: scroll">
    <table class="table table-striped" style="border-style: solid">
        ...
        <tr>
            ...
            <td style="border-style: solid">{{$reservation['petshop_id']}}</td>
            ...
            <td style="border-style: solid">{{$reservation['price']}}</td>
