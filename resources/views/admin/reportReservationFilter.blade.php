...
<div>
    ...
    <h2 style="margin-left: 50px">Filter Reservation Report by</h2>

    <form action="/admin/reportReservationData" method="post" style="margin-left: 50px" >
        <label for="start_date" style="margin-right:10px;">Booking Date</label><br>
        <label for="start_date" style="margin-right:10px;">Start</label>
        <input type="date" name="start_date" id="start_date">
        <label for="end_date" style="margin-right:10px; margin-left: 20px">End</label>
